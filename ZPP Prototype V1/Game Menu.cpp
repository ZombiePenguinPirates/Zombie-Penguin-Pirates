...
INTERFACEOBJECT UserInterface[28];
...
void initMenu()
{
	...
	UserInterface[1].SetImageSize(336, 111);
	UserInterface[1].SetSize(215, 50);
	UserInterface[1].SetPos(350, 160);
	//and added the render function to end of drawgame
	UserInterface[1].SetState(new_game);

	//added these 3 lines in initgame
	UserInterface[2].SetPic(6);								//load game
	UserInterface[2].SetImageSize(320, 102);
	UserInterface[2].SetSize(210, 50);
	UserInterface[2].SetPos(350, 215);
	//and added the render function to end of drawgame
	UserInterface[2].SetState(load_game);

	//added these 3 lines in initgame
	UserInterface[3].SetPic(3);								//settings
	UserInterface[3].SetImageSize(325, 102);
	UserInterface[3].SetSize(210, 50);
	UserInterface[3].SetPos(350, 270);
	//and added the render function to end of drawgame
	UserInterface[3].SetState(settings);

	//added these 3 lines in initgame
	UserInterface[4].SetPic(4);								//tutorials
	UserInterface[4].SetImageSize(324, 102);
	UserInterface[4].SetSize(210, 50);
	UserInterface[4].SetPos(350, 325);
	//and added the render function to end of drawgame
		UserInterface[4].SetState(tutorials);
	
	//added these 3 lines in initgame
	UserInterface[5].SetPic(5);								//quit_game
	UserInterface[5].SetImageSize(320, 99);
	UserInterface[5].SetSize(210, 50);
	UserInterface[5].SetPos(350, 380);
	//and added the render function to end of drawgame
	...
	UserInterface[6].SetPos(350, 210);
	//and added the render function to end of drawgame
	...
	UserInterface[7].SetPos(350, 260);
	//and added the render function to end of drawgame
	...
	UserInterface[11].SetPos(350, 210);
	//and added the render function to end of drawgame
	...
	UserInterface[12].SetPos(350, 260);
	//and added the render function to end of drawgame
	...
	UserInterface[13].SetPos(350, 310);
	//and added the render function to end of drawgame
		UserInterface[13].SetState(main_menu);

		//added these 3 lines in initgame
	UserInterface[14].SetPic(15);							//back
	UserInterface[14].SetImageSize(320, 99);
	UserInterface[14].SetSize(210, 50);
	UserInterface[14].SetPos(350, 380);
	//and added the render function to end of drawgame
	UserInterface[14].SetState(main_menu);

		//added these 3 lines in initgame
	UserInterface[15].SetPic(16);							//yes
	UserInterface[15].SetImageSize(320, 99);
	UserInterface[15].SetSize(210, 50);
	UserInterface[15].SetPos(350, 260);
	//and added the render function to end of drawgame
	UserInterface[15].SetState(quit_for_real);

		//added these 3 lines in initgame
	UserInterface[16].SetPic(17);							//no
	UserInterface[16].SetImageSize(320, 99);
	UserInterface[16].SetSize(210, 50);
	UserInterface[16].SetPos(350, 360);
	//and added the render function to end of drawgame
	UserInterface[16].SetState(main_menu);

		//added these 3 lines in initgame
	UserInterface[17].SetPic(18);							//audio
	UserInterface[17].SetImageSize(320, 99);
	UserInterface[17].SetSize(210, 50);
	UserInterface[17].SetPos(350, 210);
	//and added the render function to end of drawgame 
	UserInterface[17].SetState(main_menu);

	//added these 3 lines in initgame
	UserInterface[18].SetPic(6);							//load_menu
	UserInterface[18].SetImageSize(320, 99);
	UserInterface[18].SetSize(210, 50);
	UserInterface[18].SetPos(350, 160);
	//and added the render function to end of drawgame
	UserInterface[18].SetState(load_game);

	//added these 3 lines in initgame
	UserInterface[19].SetPic(3);							//settings_menu
	UserInterface[19].SetImageSize(320, 99);
	UserInterface[19].SetSize(210, 50);
	UserInterface[19].SetPos(350, 160);
	//and added the render function to end of drawgame
	...
	UserInterface[20].SetImageSize(320, 99);
	UserInterface[20].SetSize(210, 50);
	UserInterface[20].SetPos(350, 160);
	//and added the render function to end of drawgame
	UserInterface[20].SetState(tutorials);

	//added these 3 lines in initgame
	UserInterface[21].SetPic(5);							//quit_menu
	UserInterface[21].SetImageSize(320, 99);
	UserInterface[21].SetSize(210, 50);
	UserInterface[21].SetPos(350, 160);
	//and added the render function to end of drawgame
	...
	UserInterface[23].SetImageSize(320, 100);
	UserInterface[23].SetSize(150, 50);
	UserInterface[23].SetPos(270, 150);
	//and added the render function to end of drawgame
	UserInterface[23].SetState(in_game_pause_quit);

	UserInterface[24].SetPic(15);							//pause screen quit
	UserInterface[24].SetImageSize(320, 100);
	UserInterface[24].SetSize(210, 50);
	UserInterface[24].SetPos(270, 250);
	//and added the render function to end of drawgame
	UserInterface[24].SetState(new_game);

	UserInterface[25].SetPic(5);							//pause screen quit propper
	UserInterface[25].SetImageSize(320, 100);
	UserInterface[25].SetSize(150, 50);
	...
	UserInterface[26].SetImageSize(320, 100);
	UserInterface[26].SetSize(210, 50);
	...
	UserInterface[27].SetImageSize(320, 100);
	UserInterface[27].SetSize(210, 50);
